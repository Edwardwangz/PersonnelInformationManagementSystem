                ...
                <div class="xjhy">
                    ...
                    <ul class="hypz gjpz clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="eName" type="text"/>
                            </div>
                        </li>
                        <li class="clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="idcards" type="text"/>
                            </div>
                        </li>
                        <li class="clearfix">
                            <span class="title">出生日期：</span>
                            <div class="li_r">
                                <input class="chang" name="born" type="text"/>
                            </div>
                        </li>
                        <li class="clearfix">
                            <span class="title">备注：</span>
                            <div class="li_r">
                                <input class="chang" name="remark" type="text"/>
                            </div>
                        </li>
                        <li class="tj_btn">
